...
--------------------------------------------------------------------------------------------
Runs against real ChromaDB at ./chroma_db and real Voyage Code 2 embeddings. No mocks.
...
def _env_ready() -> bool:
    """True if Voyage key, ChromaDB package, and chroma_db directory are available for real tests."""
...
@pytest.mark.skipif(not _env_ready(), reason="VOYAGE_API_KEY and/or chroma_db not available")
